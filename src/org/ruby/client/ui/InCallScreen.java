...
import org.ruby.client.phone.CallCard;
import org.ruby.client.phone.Phone;
import org.ruby.client.phone.SlidingCardManager;
	...
	public void onResume() {
		...
		case UserAgent.UA_STATE_INCOMING_CALL:
			if (Receiver.pstn_state == null || Receiver.pstn_state.equals("IDLE"))
				if (PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(org.ruby.client.ui.Settings.PREF_AUTO_ON, org.ruby.client.ui.Settings.DEFAULT_AUTO_ON) &&
						!mKeyguardManager.inKeyguardRestrictedInputMode())
					mHandler.sendEmptyMessageDelayed(MSG_ANSWER, 1000);
				else if ((PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(org.ruby.client.ui.Settings.PREF_AUTO_ONDEMAND, org.ruby.client.ui.Settings.DEFAULT_AUTO_ONDEMAND) &&
						PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(org.ruby.client.ui.Settings.PREF_AUTO_DEMAND, org.ruby.client.ui.Settings.DEFAULT_AUTO_DEMAND)) ||
						(PreferenceManager.getDefaultSharedPreferences(mContext).getBoolean(org.ruby.client.ui.Settings.PREF_AUTO_HEADSET, org.ruby.client.ui.Settings.DEFAULT_AUTO_HEADSET) &&
								Receiver.headset > 0))
	        ...
	        (t = new Thread() {
				public void run() {
					...
					if (Settings.System.getInt(getContentResolver(),
						...
						tg = new ToneGenerator(AudioManager.STREAM_VOICE_CALL, (int)(ToneGenerator.MAX_VOLUME*2*org.ruby.client.ui.Settings.getEarGain()));
					for (;;) {
						if (!running) {
							t = null;
							break;
