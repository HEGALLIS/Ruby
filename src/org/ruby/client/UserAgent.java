...
import org.ruby.codecs.Codec;
import org.ruby.codecs.Codecs;
import org.ruby.media.JAudioLauncher;
import org.ruby.media.MediaLauncher;
...
//	private void addMediaDescriptor(String media, int port, Codecs.Map c,int rate) {
	...
	public void onCallIncoming(Call call, NameAddress callee,
		...
		int i = 0;
		for (UserAgent ua : Receiver.mEngine.uas) {
			if (ua == this) break;
			i++;
		}
