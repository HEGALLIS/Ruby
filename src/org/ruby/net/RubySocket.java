...
import org.ruby.net.impl.OSNetworkSystem;
import org.ruby.net.impl.PlainDatagramSocketImpl;

public class RubySocket extends DatagramSocket {

	PlainDatagramSocketImpl impl;
	public static boolean loaded = false;
	
	public RubySocket(int port) throws SocketException, UnknownHostException {
		super(!loaded?port:0);
		if (loaded) {
