...
import org.ruby.net.RtpPacket;
import org.ruby.net.RtpSocket;
import org.ruby.net.RubySocket;
import org.ruby.client.R;
import org.ruby.client.UserAgent;
import org.ruby.client.ui.InCallScreen;
...
public class RtpStreamReceiver extends Thread {
	 ...
	 *            the stream sink
	 * @param socket
	 *            the local receiver RubySocket
	 */
	public RtpStreamReceiver(RubySocket socket, Codecs.Map payload_type, CallRecorder rec) {
		init(socket);
		p_type = payload_type;
		call_recorder = rec;
	}
	...
	private void init(RubySocket socket) {
		if (socket != null)
	...
	public static synchronized void ringback(boolean ringback) {
		if (ringback && ringbackPlayer == null) {
			...
			setMode(speakermode);
			enableBluetooth(PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(org.ruby.client.ui.Settings.PREF_BLUETOOTH,
					org.ruby.client.ui.Settings.DEFAULT_BLUETOOTH));
			...
			ringbackPlayer = new ToneGenerator(stream(),(int)(ToneGenerator.MAX_VOLUME*2*org.ruby.client.ui.Settings.getEarGain()));
	...
	void restoreVolume() {
		...
		case AudioManager.MODE_IN_CALL:
				...
				if (oldring > 0) setStreamVolume(AudioManager.STREAM_RING,(int)(
						...
						org.ruby.client.ui.Settings.getEarGain()*3/4), 0);
				track.setStereoVolume(AudioTrack.getMaxVolume()*
						org.ruby.client.ui.Settings.getEarGain()
	...
	void saveSettings() {
		if (!PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(org.ruby.client.ui.Settings.PREF_OLDVALID, org.ruby.client.ui.Settings.DEFAULT_OLDVALID)) {
			...
			if (!PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).contains(org.ruby.client.ui.Settings.PREF_OLDVIBRATE2))
			...
			Editor edit = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).edit();
			edit.putInt(org.ruby.client.ui.Settings.PREF_OLDVIBRATE, oldvibrate);
			edit.putInt(org.ruby.client.ui.Settings.PREF_OLDVIBRATE2, oldvibrate2);
			edit.putInt(org.ruby.client.ui.Settings.PREF_OLDPOLICY, oldpolicy);
			edit.putInt(org.ruby.client.ui.Settings.PREF_OLDRING, am.getStreamVolume(AudioManager.STREAM_RING));
			edit.putBoolean(org.ruby.client.ui.Settings.PREF_OLDVALID, true);
			edit.commit();
		}
	}
	...
	public static void setMode(int mode) {
		Editor edit = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).edit();
		edit.putBoolean(org.ruby.client.ui.Settings.PREF_SETMODE, true);
		edit.commit();
		AudioManager am = (AudioManager) Receiver.mContext.getSystemService(Context.AUDIO_SERVICE);
		if (Integer.parseInt(Build.VERSION.SDK) >= 5) {
	...
	public static void restoreMode() {
		if (PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(org.ruby.client.ui.Settings.PREF_SETMODE, org.ruby.client.ui.Settings.DEFAULT_SETMODE)) {
			Editor edit = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).edit();
			edit.putBoolean(org.ruby.client.ui.Settings.PREF_SETMODE, false);
			edit.commit();
	...
	public static void restoreSettings() {
		if (PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(org.ruby.client.ui.Settings.PREF_OLDVALID, org.ruby.client.ui.Settings.DEFAULT_OLDVALID)) {
			...
			int oldvibrate = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getInt(org.ruby.client.ui.Settings.PREF_OLDVIBRATE, org.ruby.client.ui.Settings.DEFAULT_OLDVIBRATE);
			int oldvibrate2 = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getInt(org.ruby.client.ui.Settings.PREF_OLDVIBRATE2, org.ruby.client.ui.Settings.DEFAULT_OLDVIBRATE2);
			int oldpolicy = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getInt(org.ruby.client.ui.Settings.PREF_OLDPOLICY, org.ruby.client.ui.Settings.DEFAULT_OLDPOLICY);
			...
			Editor edit = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).edit();
			edit.putBoolean(org.ruby.client.ui.Settings.PREF_OLDVALID, false);
			edit.commit();
			PowerManager pm = (PowerManager) Receiver.mContext.getSystemService(Context.POWER_SERVICE);
			PowerManager.WakeLock wl = pm.newWakeLock(PowerManager.SCREEN_BRIGHT_WAKE_LOCK |
					PowerManager.ACQUIRE_CAUSES_WAKEUP, "Ruby.RtpStreamReceiver");
			wl.acquire(1000);
		}
		restoreMode();
	}
	...
	void empty() {
		try {
			...
			if (!Ruby.release) e2.printStackTrace();
		} catch (IOException e) {
		}
		try {
	...
	void lock(boolean lock) {
		try {
			if (lock) {
				...
				if (lockFirst || lockLast != lockNew) {
					...
					if (pwl == null) {
						PowerManager pm = (PowerManager) Receiver.mContext.getSystemService(Context.POWER_SERVICE);
						pwl = pm.newWakeLock(lockNew?(PowerManager.SCREEN_DIM_WAKE_LOCK | PowerManager.ACQUIRE_CAUSES_WAKEUP):PROXIMITY_SCREEN_OFF_WAKE_LOCK, "Ruby.Receiver");
						pwl.acquire();
					}
				}
			} else {
		...
		if (lock) {
			if (pwl2 == null) {
				PowerManager pm = (PowerManager) Receiver.mContext.getSystemService(Context.POWER_SERVICE);
				pwl2 = pm.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "Ruby.Receiver");
				pwl2.acquire();
			}
		} else if (pwl2 != null) {
			pwl2.release();
	...
	public void run() {
		boolean nodata = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(org.ruby.client.ui.Settings.PREF_NODATA, org.ruby.client.ui.Settings.DEFAULT_NODATA);
		keepon = PreferenceManager.getDefaultSharedPreferences(Receiver.mContext).getBoolean(org.ruby.client.ui.Settings.PREF_KEEPON, org.ruby.client.ui.Settings.DEFAULT_KEEPON);
		...
		ToneGenerator tg = new ToneGenerator(AudioManager.STREAM_VOICE_CALL,(int)(ToneGenerator.MAX_VOLUME*2*org.ruby.client.ui.Settings.getEarGain()));
		track.play();
		System.gc();
		empty();
		lockFirst = true;
	...
	private static void println(String str) {
		if (!Ruby.release) System.out.println("RtpStreamReceiver: " + str);
	}
