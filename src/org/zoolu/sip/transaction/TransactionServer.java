...
public class TransactionServer extends Transaction {
	...
	public TransactionServer(SipProvider sip_provider, String method,
	...
	public TransactionServer(SipProvider provider, Message req,
			TransactionServerListener listener) {
		super(provider);
	...
	void init(TransactionServerListener listener,
